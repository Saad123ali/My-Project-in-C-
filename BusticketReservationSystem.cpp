...
//             cout << "Driver name: ";
//             cin.ignore();
//             getline(cin, buses[busNo].drivername);
//             cout << "Bus Plate Number: ";
//             getline(cin, buses[busNo].busnumber);
//             cout << "Departure time: ";
//             // cin.ignore();
//             getline(cin, buses[busNo].departuretime);
//             cout << "Arrival time: ";
//             getline(cin, buses[busNo].arrivaltime);
//             cout << "From: ";
//             getline(cin, buses[busNo].from);
//             cout << "To: ";
//             getline(cin, buses[busNo].to);
//             cout << "Total seats: 20\n";
//             buses[busNo].totalseats = 20;
//             busNo++;
//         }
//         else
//         {
//             cout << "\nCannot add more buses" << endl;
//             break;
//         }
...
//     // Check if the bus details are already entered
//     if (!buses[busNo - 1].drivername.empty())
//     {
//         cout << "Bus details already entered." << endl;
//         return;
//     }
